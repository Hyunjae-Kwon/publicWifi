...
<body>
	...
	<form action="updateBookmarkGrpSubmit.jsp" id="bookMarkGrp">
		<table class="detail">
			...
			<tr>
				<th style="background-color: white;" colspan="2"><a href="http://localhost:8080/bookmarkGrp.jsp">돌아가기</a><a>|</a><button type="submit" form="bookMarkGrp">수정</button></th>
			</tr>
			<% } %>
		</table>
	</form>
